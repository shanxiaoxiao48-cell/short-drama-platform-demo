...
export function PermissionProvider({ children }: { children: ReactNode }) {
  ...
  // During SSR or before client hydration, render children with default values
  ...
  if (!isClient) {
    return (
      <PermissionContext.Provider value={{
        user: DEFAULT_USER,
        setUser: (u: User) => {},
        switchRole: (r: UserRole) => {},
        hasMenu: () => true,
        hasButton: () => true,
        hasWorkflow: () => true,
        canAccessProject: () => true,
        canAccessVariant: () => true,
      }}>
        {children}
