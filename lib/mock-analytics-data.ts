...
export const translatorStats = {
  ...
  totalCost: mockTranslators.reduce((sum, t) => sum + t.cost, 0), // ¥590,400
  ...
  avgModificationRate: mockTranslators.reduce((sum, t) => sum + t.modificationRate, 0) / mockTranslators.length, // 12.4%
  ...
  highRatingCount: mockTranslators.filter(t => t.qualityRating === "S" || t.qualityRating === "A+").length, // 4人
  highRatingPercentage: Math.round((mockTranslators.filter(t => t.qualityRating === "S" || t.qualityRating === "A+").length / mockTranslators.length) * 100), // 33%
}
...
export const mockCosts: Cost[] = [
  { id: "c1", languageVersionId: "lv1", translatorId: "1", unitPrice: 45.0, totalMinutes: 1560, totalCost: 70200 },
  ...
  { id: "c5", languageVersionId: "lv5", translatorId: "5", unitPrice: 2.0, totalMinutes: 810, totalCost: 1620 },
  { id: "c6", languageVersionId: "lv6", translatorId: "3", unitPrice: 2.0, totalMinutes: 720, totalCost: 1440 },
  { id: "c7", languageVersionId: "lv7", translatorId: "3", unitPrice: 2.0, totalMinutes: 0, totalCost: 0 },
  { id: "c8", languageVersionId: "lv8", translatorId: "1", unitPrice: 2.0, totalMinutes: 0, totalCost: 0 },
  { id: "c9", languageVersionId: "lv9", translatorId: "4", unitPrice: 2.0, totalMinutes: 2100, totalCost: 4200 },
  { id: "c10", languageVersionId: "lv10", translatorId: "3", unitPrice: 2.0, totalMinutes: 2100, totalCost: 4200 },
  { id: "c11", languageVersionId: "lv11", translatorId: "3", unitPrice: 2.0, totalMinutes: 2100, totalCost: 4200 }
]
...
export const mockAdSpends: AdSpend[] = [
  ...
  { id: "a3", languageVersionId: "lv3", spend: 16320, date: "2024-01-27" },
  { id: "a4", languageVersionId: "lv4", spend: 4320, date: "2024-01-27" },
  { id: "a5", languageVersionId: "lv5", spend: 16896, date: "2024-01-27" },
  { id: "a6", languageVersionId: "lv6", spend: 4860, date: "2024-01-27" },
  { id: "a7", languageVersionId: "lv7", spend: 63840, date: "2024-01-27" },
  { id: "a8", languageVersionId: "lv8", spend: 0, date: "2024-01-20" },
  { id: "a9", languageVersionId: "lv9", spend: 13440, date: "2024-01-27" },
  { id: "a10", languageVersionId: "lv10", spend: 13440, date: "2024-01-27" },
  { id: "a11", languageVersionId: "lv11", spend: 26880, date: "2024-01-27" }
]
...
export const languageDistributionData = [
  ...
  { language: "简体中文", count: 38, percentage: 15.6 },
  { language: "繁体中文", count: 32, percentage: 13.2 },
  { language: "西班牙语", count: 28, percentage: 11.5 },
  { language: "葡萄牙语", count: 24, percentage: 9.9 },
  { language: "土耳其语", count: 18, percentage: 7.4 },
  { language: "泰语", count: 12, percentage: 4.9 },
  { language: "菲律宾语", count: 10, percentage: 4.1 },
  { language: "韩语", count: 8, percentage: 3.3 },
  { language: "日语", count: 6, percentage: 2.5 },
  { language: "印尼语", count: 5, percentage: 2.1 },
  { language: "阿拉伯语", count: 4, percentage: 1.6 },
  { language: "印地语", count: 4, percentage: 1.6 },
  { language: "越南语", count: 3, percentage: 1.2 },
  { language: "德语", count: 2, percentage: 0.8 },
  { language: "法语", count: 2, percentage: 0.8 },
  { language: "马来语", count: 1, percentage: 0.4 },
  { language: "俄语", count: 1, percentage: 0.4 },
  { language: "意大利语", count: 1, percentage: 0.4 }
]
